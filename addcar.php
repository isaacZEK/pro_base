...
<button id="back"><a href="vehicles.php">BACK</a></button> 
 ...
 <div class="main">
        ...
        <form id="register"  action="upload.php" method="POST" enctype="multipart/form-data">    
            ...
            id="name" placeholder="Enter Price Of Car for One Day(in Kwacha)" required>
            <br><br>
            
            <label>GPS id : </label>
            <br>
            <input type="number" name="gps_id" min="1"
            id="name" placeholder="Enter the GPS id" required>
            <br><br>
