    ...
    if($error === 0){
        ...
        if(in_array($img_ex_lc,$allowed_exs)){
            ...
            move_uploaded_file($tmp_name,$img_upload_path);
                ...
                $available="Y";
                $gps_id=mysqli_real_escape_string($con,$_POST['gps_id']);
                $query="INSERT INTO cars(CAR_NAME,FUEL_TYPE,CAPACITY,PRICE,CAR_IMG,AVAILABLE,gps_id) values('$carname','$ftype',$capacity,$price,'$new_img_name','$available','$gps_id')";
